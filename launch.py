...
def prepare_environment():
    torch_command = os.environ.get('TORCH_COMMAND', "pip install torch==1.12.1+cu113 torchvision==0.13.1+cu113 --ex --extra-index-url https://download.pytorch.org/whl/cu113")
