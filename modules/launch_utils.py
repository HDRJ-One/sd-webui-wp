...
def prepare_environment():
    ...
    stable_diffusion_xl_repo = os.environ.get('STABLE_DIFFUSION_XL_REPO', "https://github.com/HDRJ-One/stable-diffusion-xl-base-1.0.git")
    ...
    stable_diffusion_xl_commit_hash = os.environ.get('STABLE_DIFFUSION_XL_COMMIT_HASH', "462165984030d82259a11f4367a4eed129e94a7b")
