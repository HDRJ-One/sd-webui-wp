...
def prepare_environment():
    ...
    torch_command = os.environ.get('TORCH_COMMAND', f"pip install torch==1.12.1+cu113 torchvision==0.13.1+cu113 --extra-index-url {torch_index_url}")
    if args.use_ipex:
    ...
    xformers_package = os.environ.get('XFORMERS_PACKAGE', 'xformers==0.0.16+cu113')
